...
//----------------------------------------------------------------------------------
if ( ! function_exists( 'im_minority_blog_social_array' ) ) {
	function im_minority_blog_social_array() {
		...
		return apply_filters( 'im_minority_blog_social_array_filter', $social_sites );
	}
}
...
//----------------------------------------------------------------------------------
if ( ! function_exists( 'im_minority_blog_social_icons_output' ) ) {
	function im_minority_blog_social_icons_output( $source = 'header' ) {
				...
				if ( $active_site == 'email' ) { ?>
					<a class="email" target="_blank"
					   href="mailto:<?php echo antispambot( is_email( $url ) ); ?>">
						<i class="fa fa-envelope" title="<?php esc_attr_e( 'email', 'indian-minority' ); ?>"></i>
					</a>
